...
```text
├── Final_Project.json        # Zeppelin notebook containing Hive SQL and PySpark analysis
├── airline.csv               # Airline customer review dataset
├── README.md                 # Project documentation
└── results/                  # Analysis outputs and visualizations (optional)
```
...
* Develop predictive models for customer recommendation.
* Build an interactive dashboard using Power BI or Tableau.
* Perform topic modeling to discover frequently discussed service issues.
* Expand the comparison to include additional airlines.
* Incorporate machine learning models for more advanced sentiment classification.

---

# Authors

This project was completed as part of a Big Data Analytics coursework. It demonstrates the application of Apache Hive and PySpark for data cleaning, exploratory data analysis, SQL querying, and sentiment analysis using real-world airline customer reviews.
